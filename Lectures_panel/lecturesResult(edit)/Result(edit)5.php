    ...
    <div id="wrapper">
        ...
        <div class="container-fluid">
            <div class="d-sm-flex justify-content-between align-items-center mb-4">
                <h3 class="text-dark mb-0" id="Semester-Result">+Add 5 Semester&nbsp;Result&nbsp;</h3><button class="btn btn-success bg-success border rounded-pill" type="submit"><i class="far fa-arrow-alt-circle-up"></i>&nbsp;Submit</button>
            </div>
        </div>
        <form>
            <div>
